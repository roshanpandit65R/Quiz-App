...
function nextQuestion() {
 ...
 if (currentQuiz < quizData.length) {
  ...
  quiz.innerHTML = `<h2>You answered ${score}/${quizData.length} question correctly<img src="https://timetodonate35868788.files.wordpress.com/2022/11/f39f8724-d788-40ff-a3e6-40fddd802525.gif" alt="gif"  width="50"></h2>
  <img src="https://i.gifer.com/G40H.gif" alt="gif"  width="500" height="200">
